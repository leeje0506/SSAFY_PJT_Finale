<template>
  <div class="res-back">
    ...
    <div >
      ...
      <RouterLink
        to="/"
        class="tmx-2 pr-4 pt-2.5   px-6 sm:px-8 lg:px-3 text-black text-4xl font-bold md:text-4xl hover:text-gray-700"
      >
        <span> WorldFood </span>
      </RouterLink>
    </div>
  ...
  <div class="footer-back">
    <footer class="py-6 text-white">
      <div class="container mx-auto text-center">
        <p>
          Project By:
          <a href="https://themewagon.com/" class="text-blue-500 underline"
            >Jieun&Dongheon</a
          >
        </p>
      </div>
