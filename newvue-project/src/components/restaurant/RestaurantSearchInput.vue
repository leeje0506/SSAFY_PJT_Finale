<template>
  <div class="searchMenu flex space-x-2">
      ...
      <div class="relative mt-2">
        ...
        >
          <span class="flex items-center">
            <span class="ml-3 text-xl block truncate">{{
              OptionInfo.food
            }}</span>
          </span>
          <span
    ...
    <button
      @click="searchResList"
      class="relative mt-2 cursor-default rounded-md bg-black pl-3 pr-3 text-center text-white shadow-sm ring-1 ring-inset ring-black focus:outline-none focus:ring-2 focus:ring-darkbrown sm:text-sm sm:leading-6"
    >
      음식점 찾기
    </button>
  </div>
