...
public class Restaurant {
    ...
    public List<Review> getRes_Review() {
        return Res_Review;
    }


    public void setRes_Review(List<Review> res_Review) {
        Res_Review = res_Review;
    }
    ...
    public String toString() {
        return "Restaurant [Res_Id=" + Res_Id + ", Res_Name=" + Res_Name + ", Res_Region=" + Res_Region
                ...
                + Res_GFree + ", Res_Review=" + Res_Review + "]";
    }
