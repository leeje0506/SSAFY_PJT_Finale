<template>
  <div class="searchMenu flex space-x-2">
    ...
    <button
      @click="searchResList"
      class="relative mt-2 w-50 cursor-default rounded-md bg-gray-600 pl-3 pr-3 text-center text-white shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6"
    >
      음식점 찾기
    </button>
  </div>
